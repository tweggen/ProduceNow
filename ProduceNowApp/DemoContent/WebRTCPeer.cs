...
{
    private const string REST_SIGNALING_SERVER = "http://192.168.178.21:5245/api/WebRTCSignal";  
    //"http://127.0.0.1:5245/api/WebRTCSignal"; // "http://localhost:5245/api/WebRTCSignal"; // "https://sipsorcery.cloud/api/webrtcsignal";
